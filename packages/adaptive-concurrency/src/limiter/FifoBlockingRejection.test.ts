...
import type { AcquireResult, AsyncAcquireResult } from "../Limiter.js";
...
describe("FifoBlockingRejection", () => {
  it("should acquire immediately when under limit", async () => {
    const limiter = new Limiter<void, AsyncAcquireResult>({
